       ...
       return true;
        ...
        function validateInvestmentAmount(amount, type) {
            const INVESTMENT_LIMITS = {
                ...
                standard: { min: 1001, max: 5000 },
                premium: { min: 5001, max: 10000 },
                VIP: { min: 10001, max: 50000 }
            };
